...
class Information:
    ...
    def from_dict(cls, info_dict):
        ...
        """
        meta = info_dict.get("meta", None) or {}
        # Carry images through if present
        if "images" in info_dict:
            meta["images"] = info_dict["images"]
        info = cls(
            url=info_dict["url"],
...
class Retriever:
    ...
    def retrieve(
        ...
        # Process queries sequentially so semantic cache can benefit from
        # earlier queries within the same batch
