...
def get_wiki_page_title_and_toc(url):
    ...
    headers = {"User-Agent": "Mozilla/5.0 (compatible; STORMBot/1.0; research project)"}
    ...
    h1 = soup.find("h1")
    if h1 is None:
        raise ValueError(f"No h1 tag found on page (possible bot block): {url}")
...
class FindRelatedTopic(dspy.Signature):
    """I'm writing a stakeholders report to the public for this topic. Please identify and recommend some Wikipedia pages on closely related subjects. I'm looking for examples that provide insights into interesting aspects commonly associated with this topic, or examples that help me understand the typical content and structure included in Wikipedia pages for similar topics.
...
class GenPersona(dspy.Signature):
    """You need to select a group of consultants who will work together to create a comprehensive report on the topic. Each of them represents a different perspective, role, or affiliation related to this topic. You can use other Wikipedia pages of related topics for inspiration. Make each role 2 Words long as a description of its general role to society. Also make sure each consultant addresses the content and context of the article in terms of its content and not chronological. For each consultant, add a description of what they will focus on.
    Give your answer in the following format: 1. short summary of consultant 1: description\n2. short summary of consultant 2: description\n...
    """
